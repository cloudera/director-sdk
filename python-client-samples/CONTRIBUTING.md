Thanks for your interest in contributing to Cloudera Director Python client samples!

The Cloudera Director Python client samples project is an Apache-licensed, open source project associated with [Cloudera Director](https://www.cloudera.com/products/product-components/cloudera-director.html). This document contains guidelines for how to contribute to the project.
