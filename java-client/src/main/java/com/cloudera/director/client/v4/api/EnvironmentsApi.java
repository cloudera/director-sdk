...
import com.cloudera.director.client.v4.model.Environment;
...
public class EnvironmentsApi {
  ...
  */
  public void create(Environment body) throws ApiException {
    ...
    String path = "/api/v4/environments".replaceAll("\\{format\\}", "json");
  ...
  */
  public void delete(String name) throws ApiException {
    ...
    // create path and map variables
    String path = "/api/v4/environments/{name}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "name" + "\\}", apiClient.escapeString(name.toString()));
  ...
  */
  public void updateProviderCredentials(String name, Map<String, String> body) throws ApiException {
    ...
    // create path and map variables
    String path = "/api/v4/environments/{name}/provider/credentials".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "name" + "\\}", apiClient.escapeString(name.toString()));
