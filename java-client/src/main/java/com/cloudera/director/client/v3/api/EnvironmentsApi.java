...
import com.cloudera.director.client.v3.model.Environment;
...
public class EnvironmentsApi {
  ...
  */
  public void create(Environment body) throws ApiException {
    ...
    String path = "/api/v3/environments".replaceAll("\\{format\\}", "json");
  ...
  */
  public void delete(String name) throws ApiException {
    ...
    // create path and map variables
    String path = "/api/v3/environments/{name}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "name" + "\\}", apiClient.escapeString(name.toString()));
