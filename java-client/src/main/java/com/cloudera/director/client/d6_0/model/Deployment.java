...
import com.cloudera.director.client.d6_0.model.Instance;
...
public class Deployment {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, hostname, port, username, password, tlsEnabled, trustedCertificate, tlsConfigurationProperties, managerInstance, repository, repositoryKeyUrl, enableEnterpriseTrial, unlimitedJce, krbAdminUsername, krbAdminPassword, javaInstallationStrategy, cmVersion);
  }
