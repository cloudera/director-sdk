...
package com.cloudera.director.client.v12.api;
...
import com.cloudera.director.client.v12.model.PasswordChange;
import com.cloudera.director.client.v12.model.User;
import com.cloudera.director.client.v12.model.UserManagementStatus;
...
public class UsersApi {
    ...
    public com.squareup.okhttp.Call createCall(User user, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/api/v12/users";
    ...
    public com.squareup.okhttp.Call currentRedactedCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v12/users/current";
    ...
    public com.squareup.okhttp.Call deleteCall(String username, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v12/users/{username}"
    ...
    /**
     * Build call for getUserManagementStatus
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getUserManagementStatusCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v12/users/managementStatus";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getUserManagementStatusValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = getUserManagementStatusCall(progressListener, progressRequestListener);
        return call;
    ...
    public UserManagementStatus getUserManagementStatus() throws ApiException {
        ApiResponse<UserManagementStatus> resp = getUserManagementStatusWithHttpInfo();
        return resp.getData();
    }
     ...
     * Gets user management status
     * 
     * @return ApiResponse&lt;UserManagementStatus&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<UserManagementStatus> getUserManagementStatusWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getUserManagementStatusValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<UserManagementStatus>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Gets user management status (asynchronously)
     * 
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getUserManagementStatusAsync(final ApiCallback<UserManagementStatus> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getUserManagementStatusValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<UserManagementStatus>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    public com.squareup.okhttp.Call updatePasswordCall(String username, PasswordChange passwords, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v12/users/{username}/password"
            .replaceAll("\\{" + "username" + "\\}", apiClient.escapeString(username.toString()));
