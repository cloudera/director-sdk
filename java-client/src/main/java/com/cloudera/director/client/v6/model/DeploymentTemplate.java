...
public class DeploymentTemplate {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(billingId, configs, enableEnterpriseTrial, externalDatabaseTemplates, externalDatabases, hostname, javaInstallationStrategy, krbAdminPassword, krbAdminUsername, license, managerVirtualInstance, name, password, port, repository, repositoryKeyUrl, unlimitedJce, username);
  }
