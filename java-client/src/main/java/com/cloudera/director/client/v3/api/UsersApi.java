...
import com.cloudera.director.client.v3.model.PasswordChange;
import com.cloudera.director.client.v3.model.User;
...
public class UsersApi {
  ...
  */
  public User currentRedacted() throws ApiException {
    ...
    // create path and map variables
    String path = "/api/v3/users/current"
      .replaceAll("\\{format\\}", "json")
      ;
  ...
  */
  public void delete(String username) throws ApiException {
    ...
    // create path and map variables
    String path = "/api/v3/users/{username}"
      .replaceAll("\\{format\\}", "json")
      .replaceAll("\\{" + "username" + "\\}",
  ...
  */
  public void updatePassword(String username, PasswordChange body) throws ApiException {
    ...
    // create path and map variables
    String path = "/api/v3/users/{username}/password"
      .replaceAll("\\{format\\}", "json")
      .replaceAll("\\{" + "username" + "\\}",
                  apiClient.escapeString(username.toString()))
      ;
