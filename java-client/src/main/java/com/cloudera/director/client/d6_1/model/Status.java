...
import com.cloudera.director.client.d6_1.model.DiagnosticDataSummary;
import com.cloudera.director.client.d6_1.model.ErrorInfo;
...
public class Status {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(stage, description, descriptionDetails, errorInfo, remainingSteps, completedSteps, health, diagnosticDataSummaries);
  }
