...
public class Deployment {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cmVersion, enableEnterpriseTrial, hostname, javaInstallationStrategy, krbAdminPassword, krbAdminUsername, managerInstance, name, password, port, repository, repositoryKeyUrl, unlimitedJce, username);
  }
