...
public class Deployment {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, hostname, port, username, password, managerInstance, repository, repositoryKeyUrl, enableEnterpriseTrial, unlimitedJce, krbAdminUsername, krbAdminPassword, javaInstallationStrategy, cmVersion);
  }
