...
import com.cloudera.director.client.v4.model.InstanceTemplate;
...
public class InstanceTemplatesApi {
  ...
  */
  public void create(String environment, InstanceTemplate body) throws ApiException {
    ...
    String path = "/api/v4/environments/{environment}/templates/instances".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "environment" + "\\}", apiClient.escapeString(environment.toString()));
  ...
  */
  public void delete(String environment, String template) throws ApiException {
    ...
    // create path and map variables
    String path = "/api/v4/environments/{environment}/templates/instances/{template}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "environment" + "\\}", apiClient.escapeString(environment.toString())).replaceAll("\\{" + "template" + "\\}", apiClient.escapeString(template.toString()));
