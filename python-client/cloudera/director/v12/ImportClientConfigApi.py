...
class ImportClientConfigApi(object):
    ...
    def importClientConfig(self, body, **kwargs):
        ...
        Returns: cloudera.director.v12.models.ImportResult
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v12.models.ImportResult')
        return responseObject
    ...
    def validate(self, body, **kwargs):
        ...
        Returns: cloudera.director.v12.models.ValidationResult
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v12.models.ValidationResult')
        return responseObject
