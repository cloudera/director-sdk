...
class ClustersApi(object):
    ...
    def collectDiagnosticData(self, environment, deployment, cluster, **kwargs):
        ...
        resourcePath = '/api/v12/environments/{environment}/deployments/{deployment}/clusters/{cluster}/diagnosticData'
    ...
    def create(self, environment, deployment, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v12.models.ClusterTemplate: clusterTemplate (required)
        ...
        resourcePath = '/api/v12/environments/{environment}/deployments/{deployment}/clusters'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'POST'
    ...
    def delete(self, environment, deployment, cluster, **kwargs):
        ...
        resourcePath = '/api/v12/environments/{environment}/deployments/{deployment}/clusters/{cluster}'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'DELETE'
    ...
    def exportClusterConfiguration(self, environment, deployment, cluster, **kwargs):
        ...
        for (key, val) in params['kwargs'].iteritems():
            if key not in allParams:
                raise TypeError("Got an unexpected keyword argument '%s' to method exportClusterConfiguration" % key)
            params[key] = val
        del params['kwargs']

        resourcePath = '/api/v12/environments/{environment}/deployments/{deployment}/clusters/{cluster}/config'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'GET'
    ...
    def get(self, environment, deployment, cluster, **kwargs):
        ...
        Returns: cloudera.director.v12.models.Cluster
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v12.models.Cluster')
        return responseObject
    ...
    def getAdministrationSettings(self, environment, deployment, cluster, **kwargs):
        ...
        Returns: cloudera.director.v12.models.ClusterAdministrationSettings
        """
        ...
        resourcePath = '/api/v12/environments/{environment}/deployments/{deployment}/clusters/{cluster}/settings'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'GET'
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v12.models.ClusterAdministrationSettings')
        return responseObject
    ...
    def getHistory(self, environment, deployment, cluster, numEvents= None, page= None, **kwargs):
        ...
        Returns: list[cloudera.director.v12.models.ClusterUpdateEventSummary]
        """
        ...
        resourcePath = '/api/v12/environments/{environment}/deployments/{deployment}/clusters/{cluster}/history'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'GET'
        ...
        responseObject = self.apiClient.deserialize(response, 'list[cloudera.director.v12.models.ClusterUpdateEventSummary]')
        return responseObject
    ...
    def getMetrics(self, environment, deployment, cluster, **kwargs):
        ...
        Returns: cloudera.director.v12.models.Metrics
        """
        ...
        resourcePath = '/api/v12/environments/{environment}/deployments/{deployment}/clusters/{cluster}/metrics'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'GET'
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v12.models.Metrics')
        return responseObject
    ...
    def getStatus(self, environment, deployment, cluster, **kwargs):
        ...
        Returns: cloudera.director.v12.models.Status
        """
        ...
        resourcePath = '/api/v12/environments/{environment}/deployments/{deployment}/clusters/{cluster}/status'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'GET'
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v12.models.Status')
        return responseObject
    ...
    def getTemplateRedacted(self, environment, deployment, cluster, **kwargs):
        ...
        Returns: cloudera.director.v12.models.ClusterTemplate
        """
        ...
        resourcePath = '/api/v12/environments/{environment}/deployments/{deployment}/clusters/{cluster}/template'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'GET'
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v12.models.ClusterTemplate')
        return responseObject
    ...
    def update(self, environment, deployment, cluster, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v12.models.ClusterTemplate: desired (required)
    ...
    def updateAdministrationSettings(self, environment, deployment, cluster, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v12.models.ClusterAdministrationSettings: administrationSettings (required)
