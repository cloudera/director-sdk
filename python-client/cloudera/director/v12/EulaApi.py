...
class EulaApi(object):
    ...
    def get(self, **kwargs):
        ...
        Returns: cloudera.director.v12.models.Eula
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v12.models.Eula')
    ...
    def update(self, body, **kwargs):
        ...
        Args:
            body, cloudera.director.v12.models.Eula: eula (required)
