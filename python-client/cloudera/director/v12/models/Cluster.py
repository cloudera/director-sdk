...
class Cluster:
    ...
    def __init__(self, **kwargs):
        self.swaggerTypes = {
            'createdExternalDatabases': 'list[cloudera.director.v12.models.ExternalDatabase]',
            'featureAvailability': 'dict[str,str]',
            'health': 'cloudera.director.v12.models.Health',
            'instances': 'list[cloudera.director.v12.models.Instance]',
            'instancesUrl': 'str',
            'name': 'str',
            'services': 'list[cloudera.director.v12.models.Service]',
            'url': 'str'
        ...
        self.createdExternalDatabases = kwargs.get('createdExternalDatabases',[]) # list[cloudera.director.v12.models.ExternalDatabase]
        ...
        self.instances = kwargs.get('instances',[]) # list[cloudera.director.v12.models.Instance]
        ...
        self.services = kwargs.get('services',[]) # list[cloudera.director.v12.models.Service]
