...
class ClusterTemplate:
    ...
    def __init__(self, **kwargs):
        self.swaggerTypes = {
            'administrationSettings': 'cloudera.director.v12.models.ClusterAdministrationSettings',
            ...
            'migrations': 'set[cloudera.director.v12.models.Migration]',
            'name': 'str',
            ...
            'virtualInstanceGroups': 'dict[str,cloudera.director.v12.models.VirtualInstanceGroup]'

        }


        #Optional cluster administration settings
        self.administrationSettings = kwargs.get('administrationSettings',None) # cloudera.director.v12.models.ClusterAdministrationSettings
        ...
        self.migrations = kwargs.get('migrations',set()) # set[cloudera.director.v12.models.Migration]
        #Cluster name
        ...
        self.virtualInstanceGroups = kwargs.get('virtualInstanceGroups',{}) # dict[str,cloudera.director.v12.models.VirtualInstanceGroup]
