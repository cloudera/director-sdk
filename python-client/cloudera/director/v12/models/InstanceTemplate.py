...
class InstanceTemplate:
    ...
    def __init__(self, **kwargs):
        self.swaggerTypes = {
            ...
            'image': 'str',
            'name': 'str',
            'normalizationConfig': 'cloudera.director.v12.models.NormalizationConfiguration',
        ...
        self.normalizationConfig = kwargs.get('normalizationConfig',None) # cloudera.director.v12.models.NormalizationConfiguration
