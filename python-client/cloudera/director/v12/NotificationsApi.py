...
class NotificationsApi(object):
    ...
    def get(self, **kwargs):
        ...
        Returns: list[cloudera.director.v12.models.Notification]
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'list[cloudera.director.v12.models.Notification]')
