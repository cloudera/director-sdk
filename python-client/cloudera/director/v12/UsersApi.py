...
class UsersApi(object):
    ...
    def create(self, body, **kwargs):
        ...
        Args:
            body, cloudera.director.v12.models.User: user (required)
    ...
    def currentRedacted(self, **kwargs):
        ...
        Returns: cloudera.director.v12.models.User
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v12.models.User')
    ...
    def getUserManagementStatus(self, **kwargs):
        ...
        Returns: cloudera.director.v12.models.UserManagementStatus
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v12.models.UserManagementStatus')
        return responseObject
    ...
    def updatePassword(self, username, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v12.models.PasswordChange: passwords (required)
