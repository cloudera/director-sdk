...
class DeploymentsApi(object):
    ...
    def create(self, environment, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v11.models.DeploymentTemplate: deploymentTemplate (required)
    ...
    def getRedacted(self, environment, deployment, **kwargs):
        ...
        Returns: cloudera.director.v11.models.Deployment
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v11.models.Deployment')
    ...
    def getTemplateRedacted(self, environment, deployment, **kwargs):
        ...
        Returns: cloudera.director.v11.models.DeploymentTemplate
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v11.models.DeploymentTemplate')
        return responseObject
    ...
    def update(self, environment, deployment, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v11.models.DeploymentTemplate: updatedTemplate (required)
    ...
    def updateMeteringSetting(self, environment, deployment, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v11.models.MeteringSetting: meteringSetting (required)
