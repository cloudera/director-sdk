...
class ImportClientConfigApi(object):
    ...
    def importClientConfig(self, body, **kwargs):
        ...
        Returns: cloudera.director.v11.models.ImportResult
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v11.models.ImportResult')
    ...
    def validate(self, body, **kwargs):
        ...
        Returns: cloudera.director.v11.models.ValidationResult
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v11.models.ValidationResult')
        return responseObject
