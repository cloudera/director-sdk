...
class EnvironmentsApi(object):
    ...
    def delete_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v11/environments/{name}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_provider_credentials_with_http_info(self, name, credentials, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v11/environments/{name}/provider/credentials', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
