...
class DeploymentTemplate:
    ...
    def __init__(self, **kwargs):
        self.swaggerTypes = {
            ...
            'externalAccounts': 'dict[str,cloudera.director.v11.models.ExternalAccount]',
            ...
            'license': 'str',
            'managerVirtualInstance': 'cloudera.director.v11.models.VirtualInstance',
            'name': 'str',
            'password': 'str',
            'port': 'int',
        ...
        self.externalAccounts = kwargs.get('externalAccounts',{}) # dict[str,cloudera.director.v11.models.ExternalAccount]
        ...
        self.managerVirtualInstance = kwargs.get('managerVirtualInstance',None) # cloudera.director.v11.models.VirtualInstance
        #Deployment name
