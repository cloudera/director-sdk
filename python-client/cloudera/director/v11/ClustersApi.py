...
class ClustersApi(object):
    ...
    def collectDiagnosticData(self, environment, deployment, cluster, **kwargs):
        ...
        resourcePath = '/api/v11/environments/{environment}/deployments/{deployment}/clusters/{cluster}/diagnosticData'
    ...
    def create(self, environment, deployment, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v11.models.ClusterTemplate: clusterTemplate (required)
        ...
        resourcePath = '/api/v11/environments/{environment}/deployments/{deployment}/clusters'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'POST'
    ...
    def delete(self, environment, deployment, cluster, **kwargs):
        ...
        resourcePath = '/api/v11/environments/{environment}/deployments/{deployment}/clusters/{cluster}'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'DELETE'
    ...
    def get(self, environment, deployment, cluster, **kwargs):
        ...
        Returns: cloudera.director.v11.models.Cluster
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v11.models.Cluster')
    ...
    def getAdministrationSettings(self, environment, deployment, cluster, **kwargs):
        ...
        Returns: cloudera.director.v11.models.ClusterAdministrationSettings
        """
        ...
        resourcePath = '/api/v11/environments/{environment}/deployments/{deployment}/clusters/{cluster}/settings'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'GET'
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v11.models.ClusterAdministrationSettings')
        return responseObject
    ...
    def getHistory(self, environment, deployment, cluster, numEvents= None, page= None, **kwargs):
        ...
        Returns: list[cloudera.director.v11.models.ClusterUpdateEventSummary]
        """
        ...
        resourcePath = '/api/v11/environments/{environment}/deployments/{deployment}/clusters/{cluster}/history'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'GET'
        ...
        responseObject = self.apiClient.deserialize(response, 'list[cloudera.director.v11.models.ClusterUpdateEventSummary]')
        return responseObject
    ...
    def getMetrics(self, environment, deployment, cluster, **kwargs):
        ...
        Returns: cloudera.director.v11.models.Metrics
        """
        ...
        resourcePath = '/api/v11/environments/{environment}/deployments/{deployment}/clusters/{cluster}/metrics'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'GET'
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v11.models.Metrics')
        return responseObject
    ...
    def getStatus(self, environment, deployment, cluster, **kwargs):
        ...
        Returns: cloudera.director.v11.models.Status
        """
        ...
        resourcePath = '/api/v11/environments/{environment}/deployments/{deployment}/clusters/{cluster}/status'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'GET'
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v11.models.Status')
        return responseObject
    ...
    def getTemplateRedacted(self, environment, deployment, cluster, **kwargs):
        ...
        Returns: cloudera.director.v11.models.ClusterTemplate
        """
        ...
        resourcePath = '/api/v11/environments/{environment}/deployments/{deployment}/clusters/{cluster}/template'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'GET'
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v11.models.ClusterTemplate')
        return responseObject
    ...
    def update(self, environment, deployment, cluster, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v11.models.ClusterTemplate: desired (required)
    ...
    def updateAdministrationSettings(self, environment, deployment, cluster, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v11.models.ClusterAdministrationSettings: administrationSettings (required)
