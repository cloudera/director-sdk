...
class ClusterTemplate:
    ...
    def __init__(self, **kwargs):
        self.swaggerTypes = {
            'externalDatabaseTemplates': 'dict[str,cloudera.director.v4.models.ExternalDatabaseTemplate]',
            'externalDatabases': 'dict[str,cloudera.director.v4.models.ExternalDatabase]',
            'migrations': 'set[cloudera.director.v4.models.Migration]',
            'name': 'str',
            ...
            'virtualInstanceGroups': 'dict[str,cloudera.director.v4.models.VirtualInstanceGroup]'

        }


        #Optional external database templates
        self.externalDatabaseTemplates = kwargs.get('externalDatabaseTemplates',{}) # dict[str,cloudera.director.v4.models.ExternalDatabaseTemplate]
        #Optional external databases
        self.externalDatabases = kwargs.get('externalDatabases',{}) # dict[str,cloudera.director.v4.models.ExternalDatabase]
        #A description of current manual migrations (read only)
        self.migrations = kwargs.get('migrations',set()) # set[cloudera.director.v4.models.Migration]
        #Cluster name
        ...
        self.virtualInstanceGroups = kwargs.get('virtualInstanceGroups',{}) # dict[str,cloudera.director.v4.models.VirtualInstanceGroup]
