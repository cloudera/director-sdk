...
class UsersApi(object):
    ...
    def create(self, body, **kwargs):
        ...
        Args:
            body, cloudera.director.v4.models.User: user (required)
    ...
    def currentRedacted(self, **kwargs):
        ...
        Returns: cloudera.director.v4.models.User
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v4.models.User')
    ...
    def updatePassword(self, username, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v4.models.PasswordChange: passwords (required)
