...
class ClustersApi(object):
    ...
    def create(self, environment, deployment, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v9.models.ClusterTemplate: clusterTemplate (required)
    ...
    def get(self, environment, deployment, cluster, **kwargs):
        ...
        Returns: cloudera.director.v9.models.Cluster
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v9.models.Cluster')
    ...
    def getAdministrationSettings(self, environment, deployment, cluster, **kwargs):
        ...
        Returns: cloudera.director.v9.models.ClusterAdministrationSettings
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v9.models.ClusterAdministrationSettings')
        return responseObject
    ...
    def getHistory(self, environment, deployment, cluster, numEvents= None, page= None, **kwargs):
        ...
        Returns: list[cloudera.director.v9.models.ClusterUpdateEventSummary]
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'list[cloudera.director.v9.models.ClusterUpdateEventSummary]')
        return responseObject
    ...
    def getMetrics(self, environment, deployment, cluster, **kwargs):
        ...
        Returns: cloudera.director.v9.models.Metrics
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v9.models.Metrics')
        return responseObject
    ...
    def getTemplateRedacted(self, environment, deployment, cluster, **kwargs):
        ...
        Returns: cloudera.director.v9.models.ClusterTemplate
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v9.models.ClusterTemplate')
        return responseObject
    ...
    def update(self, environment, deployment, cluster, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v9.models.ClusterTemplate: desired (required)
    ...
    def updateAdministrationSettings(self, environment, deployment, cluster, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v9.models.ClusterAdministrationSettings: administrationSettings (required)
