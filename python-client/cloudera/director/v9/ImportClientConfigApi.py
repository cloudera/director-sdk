...
class ImportClientConfigApi(object):
    ...
    def importClientConfig(self, body, **kwargs):
        ...
        Returns: cloudera.director.v9.models.ImportResult
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v9.models.ImportResult')
    ...
    def validate(self, body, **kwargs):
        ...
        Returns: cloudera.director.v9.models.ValidationResult
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v9.models.ValidationResult')
        return responseObject
