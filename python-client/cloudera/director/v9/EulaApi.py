...
class EulaApi(object):
    ...
    def get(self, **kwargs):
        ...
        Returns: cloudera.director.v9.models.Eula
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v9.models.Eula')
    ...
    def update(self, body, **kwargs):
        ...
        Args:
            body, cloudera.director.v9.models.Eula: eula (required)
