...
class Instance(object):
    ...
    def __init__(self, ip_address=None, properties=None, virtual_instance=None, capabilities=None, cm_host_id=None, cm_host_url=None, state=None, validation_conditions=None, health=None):  # noqa: E501
