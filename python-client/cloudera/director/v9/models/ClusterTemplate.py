...
class ClusterTemplate:
    ...
    def __init__(self, **kwargs):
        self.swaggerTypes = {
            'administrationSettings': 'cloudera.director.v9.models.ClusterAdministrationSettings',
            'externalDatabaseTemplates': 'dict[str,cloudera.director.v9.models.ExternalDatabaseTemplate]',
            'externalDatabases': 'dict[str,cloudera.director.v9.models.ExternalDatabase]',
            'instancePostCreateScripts': 'list[str]',
            'migrations': 'set[cloudera.director.v9.models.Migration]',
            'name': 'str',
            ...
            'virtualInstanceGroups': 'dict[str,cloudera.director.v9.models.VirtualInstanceGroup]'

        }


        #Optional cluster administration settings
        self.administrationSettings = kwargs.get('administrationSettings',None) # cloudera.director.v9.models.ClusterAdministrationSettings
        #Optional external database templates
        self.externalDatabaseTemplates = kwargs.get('externalDatabaseTemplates',{}) # dict[str,cloudera.director.v9.models.ExternalDatabaseTemplate]
        #Optional external databases
        self.externalDatabases = kwargs.get('externalDatabases',{}) # dict[str,cloudera.director.v9.models.ExternalDatabase]
        ...
        self.migrations = kwargs.get('migrations',set()) # set[cloudera.director.v9.models.Migration]
        #Cluster name
        ...
        self.virtualInstanceGroups = kwargs.get('virtualInstanceGroups',{}) # dict[str,cloudera.director.v9.models.VirtualInstanceGroup]
