...
class Instance(object):
    ...
    def __init__(self, capabilities=None, cm_host_id=None, cm_host_url=None, health=None, ip_address=None, properties=None, state=None, validation_conditions=None, virtual_instance=None):  # noqa: E501
