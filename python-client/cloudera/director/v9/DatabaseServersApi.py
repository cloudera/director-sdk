...
class DatabaseServersApi(object):
    ...
    def create(self, environment, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v9.models.ExternalDatabaseServerTemplate: externalDatabaseServerTemplate (required)
    ...
    def getDatabaseServerUsage(self, environment, externalDatabaseServer, **kwargs):
        ...
        Returns: cloudera.director.v9.models.ExternalDatabaseServerUsage
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v9.models.ExternalDatabaseServerUsage')
    ...
    def getRedacted(self, environment, externalDatabaseServer, **kwargs):
        ...
        Returns: cloudera.director.v9.models.ExternalDatabaseServer
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v9.models.ExternalDatabaseServer')
        return responseObject
    ...
    def getTemplateRedacted(self, environment, externalDatabaseServer, **kwargs):
        ...
        Returns: cloudera.director.v9.models.ExternalDatabaseServerTemplate
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v9.models.ExternalDatabaseServerTemplate')
        return responseObject
    ...
    def update(self, environment, externalDatabaseServer, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v9.models.ExternalDatabaseServerTemplate: updatedTemplate (required)
