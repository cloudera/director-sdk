...
class DeploymentTemplate(object):
    ...
    attribute_map = {
        ...
        'repository_key_bundle_url': 'repositoryKeyBundleUrl',
    ...
    def __init__(self, name=None, manager_virtual_instance=None, external_database_templates=None, external_databases=None, configs=None, external_accounts=None, hostname=None, port=None, username=None, password=None, tls_enabled=None, trusted_certificate=None, tls_configuration_properties=None, repository=None, repository_key_url=None, repository_key_bundle_url=None, enable_enterprise_trial=None, unlimited_jce=None, krb_admin_username=None, krb_admin_password=None, java_installation_strategy=None, license=None, billing_id=None, post_create_scripts=None, csds=None):  # noqa: E501
        ...
        self._repository_key_bundle_url = None
        ...
        if repository_key_bundle_url is not None:
            self.repository_key_bundle_url = repository_key_bundle_url
    ...
    @property
    def repository_key_bundle_url(self):
        """Gets the repository_key_bundle_url of this DeploymentTemplate.  # noqa: E501

        Custom Cloudera Manager key bundle URL  # noqa: E501

        :return: The repository_key_bundle_url of this DeploymentTemplate.  # noqa: E501
        :rtype: str
        """
        return self._repository_key_bundle_url

    @repository_key_bundle_url.setter
    def repository_key_bundle_url(self, repository_key_bundle_url):
        """Sets the repository_key_bundle_url of this DeploymentTemplate.

        Custom Cloudera Manager key bundle URL  # noqa: E501

        :param repository_key_bundle_url: The repository_key_bundle_url of this DeploymentTemplate.  # noqa: E501
        :type: str
        """

        self._repository_key_bundle_url = repository_key_bundle_url
