...
class VirtualInstanceGroup(object):
    ...
    @property
    def name(self):
        """Gets the name of this VirtualInstanceGroup.  # noqa: E501

        Virtual instance group name  # noqa: E501

        :return: The name of this VirtualInstanceGroup.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this VirtualInstanceGroup.

        Virtual instance group name  # noqa: E501

        :param name: The name of this VirtualInstanceGroup.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def service_type_to_role_types(self):
        """Gets the service_type_to_role_types of this VirtualInstanceGroup.  # noqa: E501

        Role assignments  # noqa: E501

        :return: The service_type_to_role_types of this VirtualInstanceGroup.  # noqa: E501
        :rtype: dict(str, list[str])
        """
        return self._service_type_to_role_types

    @service_type_to_role_types.setter
    def service_type_to_role_types(self, service_type_to_role_types):
        """Sets the service_type_to_role_types of this VirtualInstanceGroup.

        Role assignments  # noqa: E501

        :param service_type_to_role_types: The service_type_to_role_types of this VirtualInstanceGroup.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VirtualInstanceGroup):
            return False
