...
class UsersApi(object):
    ...
    def create(self, body, **kwargs):
        ...
        Args:
            body, cloudera.director.v5.models.User: user (required)
    ...
    def currentRedacted(self, **kwargs):
        ...
        Returns: cloudera.director.v5.models.User
        """
        ...
        resourcePath = '/api/v5/users/current'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'GET'
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v5.models.User')
    ...
    def delete(self, username, **kwargs):
        ...
        resourcePath = '/api/v5/users/{username}'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'DELETE'
    ...
    def updatePassword(self, username, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v5.models.PasswordChange: passwords (required)
        ...
        resourcePath = '/api/v5/users/{username}/password'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'PUT'
