...
class ProviderMetadataApi(object):
    ...
    def get(self, providerId, **kwargs):
        ...
        Returns: cloudera.director.v5.models.CloudProviderMetadata
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v5.models.CloudProviderMetadata')
    ...
    def list(self, **kwargs):
        ...
        Returns: list[cloudera.director.v5.models.CloudProviderMetadata]
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'list[cloudera.director.v5.models.CloudProviderMetadata]')
        return responseObject
