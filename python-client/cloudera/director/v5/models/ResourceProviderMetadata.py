...
class ResourceProviderMetadata:
    ...
    def __init__(self, **kwargs):
        self.swaggerTypes = {
            ...
            'id': 'str',
            'name': 'str',
            'resourceDisplayProperties': 'list[cloudera.director.v5.models.DisplayProperty]',
            'templateProperties': 'list[cloudera.director.v5.models.ConfigurationProperty]',
            'type': 'str'
        ...
        self.resourceDisplayProperties = kwargs.get('resourceDisplayProperties',[]) # list[cloudera.director.v5.models.DisplayProperty]
        #A list of template configuration properties for the resource provider
        self.templateProperties = kwargs.get('templateProperties',[]) # list[cloudera.director.v5.models.ConfigurationProperty]
