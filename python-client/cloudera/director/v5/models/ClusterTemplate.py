...
class ClusterTemplate:
    ...
    def __init__(self, **kwargs):
        self.swaggerTypes = {
            ...
            'migrations': 'set[cloudera.director.v5.models.Migration]',
            'name': 'str',
            ...
            'virtualInstanceGroups': 'dict[str,cloudera.director.v5.models.VirtualInstanceGroup]'
        ...
        self.migrations = kwargs.get('migrations',set()) # set[cloudera.director.v5.models.Migration]
        #Cluster name
        ...
        self.virtualInstanceGroups = kwargs.get('virtualInstanceGroups',{}) # dict[str,cloudera.director.v5.models.VirtualInstanceGroup]
