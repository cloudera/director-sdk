...
class DeploymentsApi(object):
    ...
    def create(self, environment, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v5.models.DeploymentTemplate: deploymentTemplate (required)
        ...
        resourcePath = '/api/v5/environments/{environment}/deployments'
    ...
    def delete(self, environment, deployment, **kwargs):
        ...
        resourcePath = '/api/v5/environments/{environment}/deployments/{deployment}'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'DELETE'
    ...
    def getRedacted(self, environment, deployment, **kwargs):
        ...
        Returns: cloudera.director.v5.models.Deployment
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v5.models.Deployment')
    ...
    def getStatus(self, environment, deployment, **kwargs):
        ...
        resourcePath = '/api/v5/environments/{environment}/deployments/{deployment}/status'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'GET'
    ...
    def getTemplateRedacted(self, environment, deployment, **kwargs):
        ...
        Returns: cloudera.director.v5.models.DeploymentTemplate
        """
        ...
        resourcePath = '/api/v5/environments/{environment}/deployments/{deployment}/template'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'GET'
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v5.models.DeploymentTemplate')
        return responseObject
    ...
    def update(self, environment, deployment, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v5.models.DeploymentTemplate: updatedTemplate (required)
    ...
    def updateMeteringSetting(self, environment, deployment, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v5.models.MeteringSetting: meteringSetting (required)
        ...
        resourcePath = '/api/v5/environments/{environment}/deployments/{deployment}/metering'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'PUT'
