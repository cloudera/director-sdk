...
class ClustersApi(object):
    ...
    def create(self, environment, deployment, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v5.models.ClusterTemplate: clusterTemplate (required)
    ...
    def get(self, environment, deployment, cluster, **kwargs):
        ...
        Returns: cloudera.director.v5.models.Cluster
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v5.models.Cluster')
    ...
    def getMetrics(self, environment, deployment, cluster, **kwargs):
        ...
        Returns: cloudera.director.v5.models.Metrics
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v5.models.Metrics')
        return responseObject
    ...
    def getTemplateRedacted(self, environment, deployment, cluster, **kwargs):
        ...
        Returns: cloudera.director.v5.models.ClusterTemplate
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v5.models.ClusterTemplate')
        return responseObject
    ...
    def update(self, environment, deployment, cluster, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v5.models.ClusterTemplate: desired (required)
