...
class ClustersApi(object):
    ...
    def collectDiagnosticData(self, environment, deployment, cluster, **kwargs):
        ...
        resourcePath = '/api/v7/environments/{environment}/deployments/{deployment}/clusters/{cluster}/diagnosticData'
    ...
    def create(self, environment, deployment, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v7.models.ClusterTemplate: clusterTemplate (required)
        ...
        resourcePath = '/api/v7/environments/{environment}/deployments/{deployment}/clusters'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'POST'
    ...
    def delete(self, environment, deployment, cluster, **kwargs):
        ...
        resourcePath = '/api/v7/environments/{environment}/deployments/{deployment}/clusters/{cluster}'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'DELETE'
    ...
    def get(self, environment, deployment, cluster, **kwargs):
        ...
        Returns: cloudera.director.v7.models.Cluster
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v7.models.Cluster')
    ...
    def getMetrics(self, environment, deployment, cluster, **kwargs):
        ...
        Returns: cloudera.director.v7.models.Metrics
        """
        ...
        resourcePath = '/api/v7/environments/{environment}/deployments/{deployment}/clusters/{cluster}/metrics'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'GET'
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v7.models.Metrics')
        return responseObject
    ...
    def getStatus(self, environment, deployment, cluster, **kwargs):
        ...
        resourcePath = '/api/v7/environments/{environment}/deployments/{deployment}/clusters/{cluster}/status'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'GET'
    ...
    def getTemplateRedacted(self, environment, deployment, cluster, **kwargs):
        ...
        Returns: cloudera.director.v7.models.ClusterTemplate
        """
        ...
        resourcePath = '/api/v7/environments/{environment}/deployments/{deployment}/clusters/{cluster}/template'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'GET'
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v7.models.ClusterTemplate')
        return responseObject
    ...
    def update(self, environment, deployment, cluster, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v7.models.ClusterTemplate: desired (required)
