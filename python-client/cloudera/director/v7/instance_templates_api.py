...
class InstanceTemplatesApi(object):
    ...
    def create_with_http_info(self, environment, instance_template, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v7/environments/{environment}/templates/instances', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_with_http_info(self, environment, template, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v7/environments/{environment}/templates/instances/{template}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_with_http_info(self, environment, template, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v7/environments/{environment}/templates/instances/{template}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_with_http_info(self, environment, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v7/environments/{environment}/templates/instances', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_with_http_info(self, environment, template, instance_template, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v7/environments/{environment}/templates/instances/{template}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
