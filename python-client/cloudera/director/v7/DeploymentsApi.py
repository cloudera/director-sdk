...
class DeploymentsApi(object):
    ...
    def collectDiagnosticData(self, environment, deployment, **kwargs):
        ...
        resourcePath = '/api/v7/environments/{environment}/deployments/{deployment}/diagnosticData'
    ...
    def create(self, environment, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v7.models.DeploymentTemplate: deploymentTemplate (required)
        ...
        resourcePath = '/api/v7/environments/{environment}/deployments'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'POST'
    ...
    def delete(self, environment, deployment, **kwargs):
        ...
        resourcePath = '/api/v7/environments/{environment}/deployments/{deployment}'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'DELETE'
    ...
    def getRedacted(self, environment, deployment, **kwargs):
        ...
        Returns: cloudera.director.v7.models.Deployment
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v7.models.Deployment')
    ...
    def getStatus(self, environment, deployment, **kwargs):
        ...
        Returns: cloudera.director.v7.models.Status
        """
        ...
        resourcePath = '/api/v7/environments/{environment}/deployments/{deployment}/status'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'GET'
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v7.models.Status')
        return responseObject
    ...
    def getTemplateRedacted(self, environment, deployment, **kwargs):
        ...
        Returns: cloudera.director.v7.models.DeploymentTemplate
        """
        ...
        resourcePath = '/api/v7/environments/{environment}/deployments/{deployment}/template'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'GET'
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v7.models.DeploymentTemplate')
        return responseObject
    ...
    def update(self, environment, deployment, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v7.models.DeploymentTemplate: updatedTemplate (required)
    ...
    def updateMeteringSetting(self, environment, deployment, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v7.models.MeteringSetting: meteringSetting (required)
        ...
        resourcePath = '/api/v7/environments/{environment}/deployments/{deployment}/metering'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'PUT'
