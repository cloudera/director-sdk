...
class EnvironmentsApi(object):
    ...
    def create(self, body, **kwargs):
        ...
        Args:
            body, cloudera.director.v7.models.Environment: environment (required)
    ...
    def getRedacted(self, name, **kwargs):
        ...
        Returns: cloudera.director.v7.models.Environment
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v7.models.Environment')
