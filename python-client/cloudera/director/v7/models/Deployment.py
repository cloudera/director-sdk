...
class Deployment(object):
    ...
    def __init__(self, enable_enterprise_trial=None, hostname=None, java_installation_strategy=None, krb_admin_password=None, krb_admin_username=None, manager_instance=None, name=None, password=None, port=None, repository=None, repository_key_url=None, unlimited_jce=None, username=None):  # noqa: E501
