...
class TimeSeriesAggregateStatistics:
    ...
    def __init__(self, **kwargs):
        self.swaggerTypes = {
            'count': 'long',
            'crossEntityMetadata': 'cloudera.director.v7.models.TimeSeriesCrossEntityMetadata',
            'max': 'float',
            'maxTime': 'long',
            'mean': 'float',
            'min': 'float',
        ...
        self.crossEntityMetadata = kwargs.get('crossEntityMetadata',None) # cloudera.director.v7.models.TimeSeriesCrossEntityMetadata
        #Maximum value
