...
class Status:
    ...
    def __init__(self, **kwargs):
        self.swaggerTypes = {
            ...
            'diagnosticDataSummaries': 'list[cloudera.director.v7.models.DiagnosticDataSummary]',
        ...
        self.diagnosticDataSummaries = kwargs.get('diagnosticDataSummaries',[]) # list[cloudera.director.v7.models.DiagnosticDataSummary]
