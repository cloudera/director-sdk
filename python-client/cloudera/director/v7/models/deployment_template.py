...
class DeploymentTemplate(object):
    ...
    def __init__(self, name=None, manager_virtual_instance=None, external_database_templates=None, external_databases=None, configs=None, hostname=None, port=None, username=None, password=None, repository=None, repository_key_url=None, enable_enterprise_trial=None, unlimited_jce=None, krb_admin_username=None, krb_admin_password=None, java_installation_strategy=None, license=None, billing_id=None, post_create_scripts=None):  # noqa: E501
