...
class ClustersApi(object):
    ...
    def create(self, environment, deployment, body, **kwargs):
        ...
        resourcePath = '/api/v1/environments/{environment}/deployments/{deployment}/clusters'
    ...
    def delete(self, environment, deployment, cluster, **kwargs):
        ...
        resourcePath = '/api/v1/environments/{environment}/deployments/{deployment}/clusters/{cluster}'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'DELETE'
    ...
    def getStatus(self, environment, deployment, cluster, **kwargs):
        ...
        resourcePath = '/api/v1/environments/{environment}/deployments/{deployment}/clusters/{cluster}/status'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'GET'
    ...
    def getTemplateRedacted(self, environment, deployment, cluster, **kwargs):
        ...
        resourcePath = '/api/v1/environments/{environment}/deployments/{deployment}/clusters/{cluster}/template'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'GET'
