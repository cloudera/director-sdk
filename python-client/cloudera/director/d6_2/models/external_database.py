...
class ExternalDatabase(object):
    ...
    def user(self):
        ...
        User name for access to database  # noqa: E501

        :return: The user of this ExternalDatabase.  # noqa: E501
        :rtype: str
        """
        return self._user
    ...
    @user.setter
    def user(self, user):
        """Sets the user of this ExternalDatabase.

        User name for access to database  # noqa: E501

        :param user: The user of this ExternalDatabase.  # noqa: E501
        :type: str
        """
        if user is None:
