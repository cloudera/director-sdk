...
class EulaApi(object):
    ...
    def get(self, **kwargs):
        ...
        Returns: cloudera.director.v6.models.Eula
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v6.models.Eula')
    ...
    def update(self, body, **kwargs):
        ...
        Args:
            body, cloudera.director.v6.models.Eula: eula (required)
