...
class WorkflowsApi(object):
    ...
    def describe(self, environment, deployment, cluster, workflowUuid, **kwargs):
        ...
        Returns: cloudera.director.v6.models.WorkflowStatus
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v6.models.WorkflowStatus')
    ...
    def dispatch(self, body, environment, deployment, cluster, workflowUuid, **kwargs):
        ...
        Args:
            body, cloudera.director.v6.models.Workflow: workflow (required)
