...
class VirtualInstanceGroup:
    ...
    def __init__(self, **kwargs):
        self.swaggerTypes = {
            ...
            'virtualInstances': 'list[cloudera.director.v6.models.VirtualInstance]'
        ...
        self.virtualInstances = kwargs.get('virtualInstances',[]) # list[cloudera.director.v6.models.VirtualInstance]
