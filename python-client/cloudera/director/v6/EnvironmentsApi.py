...
class EnvironmentsApi(object):
    ...
    def create(self, body, **kwargs):
        ...
        Args:
            body, cloudera.director.v6.models.Environment: environment (required)
    ...
    def getRedacted(self, name, **kwargs):
        ...
        Returns: cloudera.director.v6.models.Environment
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v6.models.Environment')
