...
class UsersApi(object):
    ...
    def create(self, body, **kwargs):
        ...
        Args:
            body, cloudera.director.v8.models.User: user (required)
    ...
    def currentRedacted(self, **kwargs):
        ...
        Returns: cloudera.director.v8.models.User
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v8.models.User')
    ...
    def updatePassword(self, username, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v8.models.PasswordChange: passwords (required)
