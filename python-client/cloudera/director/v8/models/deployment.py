...
class Deployment(object):
    ...
    def __init__(self, name=None, hostname=None, port=None, username=None, password=None, manager_instance=None, repository=None, repository_key_url=None, enable_enterprise_trial=None, unlimited_jce=None, krb_admin_username=None, krb_admin_password=None, java_installation_strategy=None):  # noqa: E501
