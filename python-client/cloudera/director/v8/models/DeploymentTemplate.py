...
class DeploymentTemplate:
    ...
    def __init__(self, **kwargs):
        self.swaggerTypes = {
            ...
            'license': 'str',
            'managerVirtualInstance': 'cloudera.director.v8.models.VirtualInstance',
            'name': 'str',
            'password': 'str',
            'port': 'int',
        ...
        self.managerVirtualInstance = kwargs.get('managerVirtualInstance',None) # cloudera.director.v8.models.VirtualInstance
        #Deployment name
