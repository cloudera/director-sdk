...
class Cluster:
    ...
    def __init__(self, **kwargs):
        self.swaggerTypes = {
            ...
            'instances': 'list[cloudera.director.v8.models.Instance]',
            'instancesUrl': 'str',
            'name': 'str',
            'services': 'list[cloudera.director.v8.models.Service]',
            'url': 'str'
        ...
        self.instances = kwargs.get('instances',[]) # list[cloudera.director.v8.models.Instance]
        ...
        self.services = kwargs.get('services',[]) # list[cloudera.director.v8.models.Service]
