...
class DeploymentTemplate(object):
    ...
    def __init__(self, billing_id=None, configs=None, csds=None, enable_enterprise_trial=None, external_database_templates=None, external_databases=None, hostname=None, java_installation_strategy=None, krb_admin_password=None, krb_admin_username=None, license=None, manager_virtual_instance=None, name=None, password=None, port=None, post_create_scripts=None, repository=None, repository_key_url=None, unlimited_jce=None, username=None):  # noqa: E501
