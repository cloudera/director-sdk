...
class EnvironmentsApi(object):
    ...
    def create(self, body, **kwargs):
        ...
        Args:
            body, cloudera.director.v8.models.Environment: environment (required)
        ...
        resourcePath = '/api/v8/environments'
    ...
    def delete(self, name, **kwargs):
        ...
        resourcePath = '/api/v8/environments/{name}'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'DELETE'
    ...
    def getRedacted(self, name, **kwargs):
        ...
        Returns: cloudera.director.v8.models.Environment
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v8.models.Environment')
    ...
    def updateProviderCredentials(self, name, body, **kwargs):
        ...
        resourcePath = '/api/v8/environments/{name}/provider/credentials'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'PUT'
