...
class InstanceTemplatesApi(object):
    ...
    def create(self, environment, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v8.models.InstanceTemplate: instanceTemplate (required)
    ...
    def get(self, environment, template, **kwargs):
        ...
        Returns: cloudera.director.v8.models.InstanceTemplate
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v8.models.InstanceTemplate')
