...
class DeploymentsApi(object):
    ...
    def collectDiagnosticData(self, environment, deployment, **kwargs):
        ...
        resourcePath = '/api/v8/environments/{environment}/deployments/{deployment}/diagnosticData'
    ...
    def create(self, environment, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v8.models.DeploymentTemplate: deploymentTemplate (required)
        ...
        resourcePath = '/api/v8/environments/{environment}/deployments'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'POST'
    ...
    def delete(self, environment, deployment, **kwargs):
        ...
        resourcePath = '/api/v8/environments/{environment}/deployments/{deployment}'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'DELETE'
    ...
    def getRedacted(self, environment, deployment, **kwargs):
        ...
        Returns: cloudera.director.v8.models.Deployment
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v8.models.Deployment')
    ...
    def getStatus(self, environment, deployment, **kwargs):
        ...
        Returns: cloudera.director.v8.models.Status
        """
        ...
        resourcePath = '/api/v8/environments/{environment}/deployments/{deployment}/status'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'GET'
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v8.models.Status')
        return responseObject
    ...
    def getTemplateRedacted(self, environment, deployment, **kwargs):
        ...
        Returns: cloudera.director.v8.models.DeploymentTemplate
        """
        ...
        resourcePath = '/api/v8/environments/{environment}/deployments/{deployment}/template'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'GET'
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v8.models.DeploymentTemplate')
        return responseObject
    ...
    def update(self, environment, deployment, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v8.models.DeploymentTemplate: updatedTemplate (required)
    ...
    def updateMeteringSetting(self, environment, deployment, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v8.models.MeteringSetting: meteringSetting (required)
        ...
        resourcePath = '/api/v8/environments/{environment}/deployments/{deployment}/metering'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'PUT'
