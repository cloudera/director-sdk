...
class InstanceTemplate(object):
    ...
    def __init__(self, bootstrap_scripts=None, config=None, image=None, name=None, normalization_config=None, normalize_instance=None, rack_id=None, ssh_host_key_retrieval_type=None, ssh_username=None, tags=None, type=None):  # noqa: E501
