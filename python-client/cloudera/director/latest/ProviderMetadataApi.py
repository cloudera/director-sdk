...
class ProviderMetadataApi(object):
    ...
    def get(self, providerId, **kwargs):
        ...
        Returns: cloudera.director.latest.models.CloudProviderMetadata
        """
        ...
        resourcePath = '/api/v10/metadata/providers/{providerId}'
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.latest.models.CloudProviderMetadata')
    ...
    def list(self, **kwargs):
        ...
        Returns: list[cloudera.director.latest.models.CloudProviderMetadata]
        """
        ...
        resourcePath = '/api/v10/metadata/providers'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'GET'
        ...
        responseObject = self.apiClient.deserialize(response, 'list[cloudera.director.latest.models.CloudProviderMetadata]')
        return responseObject
