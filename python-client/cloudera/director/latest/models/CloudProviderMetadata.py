...
class CloudProviderMetadata:
    ...
    def __init__(self, **kwargs):
        self.swaggerTypes = {
            ...
            'credentialsProperties': 'list[cloudera.director.latest.models.ConfigurationProperty]',
            'description': 'str',
            'id': 'str',
            'name': 'str',
            'resourceProviders': 'list[cloudera.director.latest.models.ResourceProviderMetadata]'
        ...
        self.credentialsProperties = kwargs.get('credentialsProperties',[]) # list[cloudera.director.latest.models.ConfigurationProperty]
        ...
        #Resource providers
        self.resourceProviders = kwargs.get('resourceProviders',[]) # list[cloudera.director.latest.models.ResourceProviderMetadata]
