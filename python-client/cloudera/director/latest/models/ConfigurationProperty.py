...
class ConfigurationProperty:
    ...
    def __init__(self, **kwargs):
        self.swaggerTypes = {
            ...
            'sensitive': 'bool',
            'type': 'str',
            'validValues': 'list[cloudera.director.latest.models.ConfigurationPropertyValue]',
            'widget': 'str'
        ...
        self.validValues = kwargs.get('validValues',[]) # list[cloudera.director.latest.models.ConfigurationPropertyValue]
