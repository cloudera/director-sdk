...
class NotificationsApi(object):
    ...
    def get(self, **kwargs):
        ...
        Returns: list[cloudera.director.latest.models.Notification]
        """
        ...
        resourcePath = '/api/v12/notifications'
        ...
        responseObject = self.apiClient.deserialize(response, 'list[cloudera.director.latest.models.Notification]')
