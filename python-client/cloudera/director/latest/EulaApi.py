...
class EulaApi(object):
    ...
    def get(self, **kwargs):
        ...
        Returns: cloudera.director.latest.models.Eula
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.latest.models.Eula')
    ...
    def update(self, body, **kwargs):
        ...
        Args:
            body, cloudera.director.latest.models.Eula: eula (required)
