...
class DatabaseServersApi(object):
    ...
    def create(self, environment, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v3.models.ExternalDatabaseServerTemplate: externalDatabaseServerTemplate (required)
    ...
    def getDatabaseServerUsage(self, environment, externalDatabaseServer, **kwargs):
        ...
        Returns: cloudera.director.v3.models.ExternalDatabaseServerUsage
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v3.models.ExternalDatabaseServerUsage')
    ...
    def getRedacted(self, environment, externalDatabaseServer, **kwargs):
        ...
        Returns: cloudera.director.v3.models.ExternalDatabaseServer
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v3.models.ExternalDatabaseServer')
        return responseObject
    ...
    def getStatus(self, environment, externalDatabaseServer, **kwargs):
        ...
        Returns: cloudera.director.v3.models.Status
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v3.models.Status')
        return responseObject
    ...
    def getTemplateRedacted(self, environment, externalDatabaseServer, **kwargs):
        ...
        Returns: cloudera.director.v3.models.ExternalDatabaseServerTemplate
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v3.models.ExternalDatabaseServerTemplate')
        return responseObject
    ...
    def update(self, environment, externalDatabaseServer, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v3.models.ExternalDatabaseServerTemplate: updatedTemplate (required)
