...
class DeploymentTemplate:
    ...
    def __init__(self, **kwargs):
        self.swaggerTypes = {
            ...
            'license': 'str',
            'managerVirtualInstance': 'cloudera.director.v3.models.VirtualInstance',
            'name': 'str',
            'password': 'str',
            'port': 'int',
            'repository': 'str',
        ...
        self.managerVirtualInstance = kwargs.get('managerVirtualInstance',None) # cloudera.director.v3.models.VirtualInstance
        #Deployment name
