...
class EulaApi(object):
    ...
    def get(self, **kwargs):
        ...
        Returns: cloudera.director.v10.models.Eula
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v10.models.Eula')
    ...
    def update(self, body, **kwargs):
        ...
        Args:
            body, cloudera.director.v10.models.Eula: eula (required)
