...
class InstanceTemplatesApi(object):
    ...
    def create(self, environment, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v10.models.InstanceTemplate: instanceTemplate (required)
        ...
        resourcePath = '/api/v10/environments/{environment}/templates/instances'
    ...
    def delete(self, environment, template, **kwargs):
        ...
        resourcePath = '/api/v10/environments/{environment}/templates/instances/{template}'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'DELETE'
    ...
    def get(self, environment, template, **kwargs):
        ...
        Returns: cloudera.director.v10.models.InstanceTemplate
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v10.models.InstanceTemplate')
