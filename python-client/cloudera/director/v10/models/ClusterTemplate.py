...
class ClusterTemplate:
    ...
    def __init__(self, **kwargs):
        self.swaggerTypes = {
            'administrationSettings': 'cloudera.director.v10.models.ClusterAdministrationSettings',
            'externalDatabaseTemplates': 'dict[str,cloudera.director.v10.models.ExternalDatabaseTemplate]',
            'externalDatabases': 'dict[str,cloudera.director.v10.models.ExternalDatabase]',
            'instancePostCreateScripts': 'list[str]',
            'migrations': 'set[cloudera.director.v10.models.Migration]',
            'name': 'str',
            ...
            'virtualInstanceGroups': 'dict[str,cloudera.director.v10.models.VirtualInstanceGroup]'

        }


        #Optional cluster administration settings
        self.administrationSettings = kwargs.get('administrationSettings',None) # cloudera.director.v10.models.ClusterAdministrationSettings
        #Optional external database templates
        self.externalDatabaseTemplates = kwargs.get('externalDatabaseTemplates',{}) # dict[str,cloudera.director.v10.models.ExternalDatabaseTemplate]
        #Optional external databases
        self.externalDatabases = kwargs.get('externalDatabases',{}) # dict[str,cloudera.director.v10.models.ExternalDatabase]
        ...
        self.migrations = kwargs.get('migrations',set()) # set[cloudera.director.v10.models.Migration]
        #Cluster name
        ...
        self.virtualInstanceGroups = kwargs.get('virtualInstanceGroups',{}) # dict[str,cloudera.director.v10.models.VirtualInstanceGroup]
