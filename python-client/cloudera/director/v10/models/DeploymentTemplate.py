...
class DeploymentTemplate:
    ...
    def __init__(self, **kwargs):
        self.swaggerTypes = {
            ...
            'externalAccounts': 'dict[str,cloudera.director.v10.models.ExternalAccount]',
            ...
            'license': 'str',
            'managerVirtualInstance': 'cloudera.director.v10.models.VirtualInstance',
            'name': 'str',
            'password': 'str',
            'port': 'int',
        ...
        self.externalAccounts = kwargs.get('externalAccounts',{}) # dict[str,cloudera.director.v10.models.ExternalAccount]
        ...
        self.managerVirtualInstance = kwargs.get('managerVirtualInstance',None) # cloudera.director.v10.models.VirtualInstance
        #Deployment name
