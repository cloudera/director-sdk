...
class DatabaseServersApi(object):
    ...
    def create(self, environment, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v10.models.ExternalDatabaseServerTemplate: externalDatabaseServerTemplate (required)
        ...
        resourcePath = '/api/v10/environments/{environment}/databaseServers'
    ...
    def delete(self, environment, externalDatabaseServer, **kwargs):
        ...
        resourcePath = '/api/v10/environments/{environment}/databaseServers/{externalDatabaseServer}'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'DELETE'
    ...
    def getDatabaseServerUsage(self, environment, externalDatabaseServer, **kwargs):
        ...
        Returns: cloudera.director.v10.models.ExternalDatabaseServerUsage
        """
        ...
        resourcePath = '/api/v10/environments/{environment}/databaseServers/{externalDatabaseServer}/usage'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'GET'
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v10.models.ExternalDatabaseServerUsage')
    ...
    def getRedacted(self, environment, externalDatabaseServer, **kwargs):
        ...
        Returns: cloudera.director.v10.models.ExternalDatabaseServer
        """
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v10.models.ExternalDatabaseServer')
        return responseObject
    ...
    def getStatus(self, environment, externalDatabaseServer, **kwargs):
        ...
        resourcePath = '/api/v10/environments/{environment}/databaseServers/{externalDatabaseServer}/status'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'GET'
    ...
    def getTemplateRedacted(self, environment, externalDatabaseServer, **kwargs):
        ...
        Returns: cloudera.director.v10.models.ExternalDatabaseServerTemplate
        """
        ...
        resourcePath = '/api/v10/environments/{environment}/databaseServers/{externalDatabaseServer}/template'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'GET'
        ...
        responseObject = self.apiClient.deserialize(response, 'cloudera.director.v10.models.ExternalDatabaseServerTemplate')
        return responseObject
    ...
    def update(self, environment, externalDatabaseServer, body, **kwargs):
        ...
        Args:
            ...
            body, cloudera.director.v10.models.ExternalDatabaseServerTemplate: updatedTemplate (required)
